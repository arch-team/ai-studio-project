...
- MySQL 8.0.28 (开发环境本地部署), Amazon Aurora MySQL 3.04.x (生产环境,兼容 MySQL 8.0), Amazon FSx for Lustre (训练数据,≥5GB/s 吞吐量), Amazon S3 + SageMaker Model Registry (模型制品), 分层检查点存储 (NVMe → FSx for Lustre → S3) (001-ai-training-platform)
