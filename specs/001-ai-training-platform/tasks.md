...
**Tests**: Tests are OPTIONAL - will be added in Polish phase if needed.
...
- [ ] T011 Setup SQLAlchemy 2.0 async database connection in backend/src/config/database.py
- [ ] T012 Create Alembic migration framework in backend/alembic/
- [ ] T013 Create base model class with common fields in backend/src/models/base.py

### Core Entity Models (Shared Across Stories)

- [ ] T014 [P] Create User model in backend/src/models/user/user.py
- [ ] T015 [P] Create Team model in backend/src/models/user/team.py
- [ ] T016 [P] Create Project model in backend/src/models/user/project.py
- [ ] T017 Create database migration for User, Team, Project in backend/alembic/versions/001_users_teams_projects.py

### Authentication & Authorization Framework

- [ ] T018 Implement JWT authentication middleware in backend/src/api/middleware/auth.py
- [ ] T019 Implement RBAC authorization framework in backend/src/services/auth/rbac.py
- [ ] T020 Create login/logout API endpoints in backend/src/api/rest/auth.py

### API Infrastructure

- [ ] T021 Create FastAPI application factory with HTTPS support in backend/src/main.py
- [ ] T022 Create API router configuration in backend/src/api/router.py
- [ ] T023 Implement global exception handler in backend/src/api/middleware/exception_handler.py
- [ ] T024 Implement request/response logging middleware in backend/src/api/middleware/logging.py
- [ ] T025 Create common response models in backend/src/api/schemas/common.py
- [ ] T026 Configure TLS 1.2+ enforcement and cipher suites in backend/src/config/tls.py
- [ ] T027 Create pagination utilities in backend/src/api/utils/pagination.py

### Frontend Infrastructure

- [ ] T028 Setup React Router configuration in frontend/src/router/index.tsx
- [ ] T029 Create authentication context and hook in frontend/src/services/auth/AuthContext.tsx
- [ ] T030 Create API client service in frontend/src/services/api/client.ts
- [ ] T031 Setup global state management (Zustand) in frontend/src/services/store/index.ts
- [ ] T032 Create shared UI components (Button, Input, Card, Modal) in frontend/src/components/shared/
...
- [ ] T032 [P] [US1] Create TrainingJob model in backend/src/models/training/training_job.py
- [ ] T033 [P] [US1] Create Checkpoint model in backend/src/models/training/checkpoint.py
- [ ] T034 [P] [US1] Create MetricsLog model in backend/src/models/monitoring/metrics_log.py
- [ ] T035 [US1] Create database migration for training entities in backend/alembic/versions/002_training_jobs.py

### Backend Services for US1

- [ ] T036 [US1] Implement TrainingJobService in backend/src/services/training/job_service.py
- [ ] T037 [US1] Implement HyperPod Training Operator integration in backend/src/services/training/operators/hyperpod_operator.py
- [ ] T038 [US1] Implement distributed training templates (DDP, FSDP, DeepSpeed) in backend/src/services/training/templates/
- [ ] T039 [US1] Implement Gang Scheduling via Kueue in backend/src/services/training/scheduler/gang_scheduler.py
- [ ] T040 [US1] Implement CheckpointService with tiered storage in backend/src/services/checkpoint/checkpoint_service.py
- [ ] T041 [US1] Implement tiered checkpoint storage (NVMe→FSx→S3) in backend/src/services/checkpoint/tiered_storage.py
- [ ] T042 [US1] Implement auto-recovery service in backend/src/services/checkpoint/recovery/auto_recovery.py
- [ ] T043 [US1] Implement MetricsCollectionService in backend/src/services/monitoring/metrics/metrics_service.py

### Backend API for US1

- [ ] T044 [US1] Create TrainingJob request/response schemas in backend/src/api/schemas/training.py
- [ ] T045 [US1] Implement POST /training-jobs endpoint in backend/src/api/rest/training/jobs.py
- [ ] T046 [US1] Implement GET /training-jobs list endpoint in backend/src/api/rest/training/jobs.py
- [ ] T047 [US1] Implement GET /training-jobs/{id} detail endpoint in backend/src/api/rest/training/jobs.py
- [ ] T048 [US1] Implement PUT /training-jobs/{id} update endpoint in backend/src/api/rest/training/jobs.py
- [ ] T049 [US1] Implement DELETE /training-jobs/{id} endpoint in backend/src/api/rest/training/jobs.py
- [ ] T050 [US1] Implement POST /training-jobs/{id}/actions/start endpoint in backend/src/api/rest/training/jobs.py
- [ ] T051 [US1] Implement POST /training-jobs/{id}/actions/stop endpoint in backend/src/api/rest/training/jobs.py
- [ ] T052 [US1] Implement POST /training-jobs/{id}/actions/resume endpoint in backend/src/api/rest/training/jobs.py
- [ ] T053 [US1] Implement GET /training-jobs/{id}/metrics endpoint in backend/src/api/rest/training/jobs.py
- [ ] T054 [US1] Implement GET /training-jobs/{id}/logs endpoint in backend/src/api/rest/training/jobs.py
- [ ] T055 [US1] Implement GET /training-jobs/{id}/checkpoints endpoint in backend/src/api/rest/training/jobs.py

### Kubernetes Resources for US1

- [ ] T056 [P] [US1] Create TrainingJob CRD definition in backend/k8s/crds/training-job-crd.yaml
- [ ] T057 [P] [US1] Create PyTorchJob deployment template in backend/k8s/deployments/pytorch-job-template.yaml
- [ ] T058 [P] [US1] Create RBAC configuration for training operator in backend/k8s/rbac/training-operator-rbac.yaml

### Frontend for US1

- [ ] T059 [P] [US1] Create TrainingJob TypeScript types in frontend/src/types/training.ts
- [ ] T060 [US1] Create TrainingJob API client in frontend/src/services/api/training.ts
- [ ] T061 [US1] Create TrainingJobList page in frontend/src/pages/training/TrainingJobList.tsx
- [ ] T062 [US1] Create TrainingJobDetail page in frontend/src/pages/training/TrainingJobDetail.tsx
- [ ] T063 [US1] Create TrainingJobCreate form in frontend/src/components/training/TrainingJobForm.tsx
- [ ] T064 [US1] Create real-time metrics chart component in frontend/src/components/training/MetricsChart.tsx
- [ ] T065 [US1] Create training logs viewer component in frontend/src/components/training/LogViewer.tsx
- [ ] T066 [US1] Create checkpoints list component in frontend/src/components/training/CheckpointList.tsx
- [ ] T067 [US1] Create job status indicator component in frontend/src/components/training/JobStatusBadge.tsx
- [ ] T068 [US1] Integrate training pages into router in frontend/src/router/training.tsx
...
- [ ] T213 Implement Amazon SageMaker Managed MLflow integration for experiment tracking in backend/src/services/model/tracking/mlflow_integration.py
