...
export const mockDatasetVersions = [
  ...
  { id: 22, dataset_id: 1, version: 'v1.2.0', description: '剔除低质量网页样本，新增代码语料子集', storage_uri: 'fsx://fs-0a1b/datasets/pretrain-v2/v1.2.0', total_size_bytes: 1099511627776, file_count: 16480, created_at: '2026-01-22T09:30:00Z', created_by_username: 'mlops-zhang' },
