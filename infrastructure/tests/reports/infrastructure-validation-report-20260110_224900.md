...
**Generated**: 2026-01-10 22:49:13 CST
...
| Suite | Status |
|-------|--------|
| ⚠️ cluster-health |  SKIPPED (script not found) |
...
```
hyperpod-i-02102dac3f2b8d8a1   Ready   <none>   9h    v1.33.5-eks-113cf36   10.0.110.140   <none>   Amazon Linux 2023.9.20251110   6.1.158-178.288.amzn2023.x86_64   containerd://1.7.27
```
